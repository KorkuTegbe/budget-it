...
import { AuthRouter, BudgetRouter, SavingsRouter, UserRouter, SpendingRouter } from './routers';
...
app.get('/', (req, res) => {
   res.json({
      message: `thanks for visiting BUDGET IT API. You should check the docs. Go to ${req.protocol}://${req.hostname}/docs`
   })
})
